...
and how the sum stagnates at $7.086$. The next term $\tfrac{1}{514}$ cannot change $7.086$ in addition as it is less than half the distance to the next representable number (round-to-nearest, section \ref{sec:roundnearest}) and the result is rounded back. In Float16 arithmetic we therefore have $7.086 + \tfrac{1}{514} = 7.086$.
